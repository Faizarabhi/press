  ...
  return (
    <div className="flex items-center justify-center w-full h-64 object-cover">
      <label
        ...
        className={`flex flex-col items-center justify-center w-full h-64 border-2 border-dashed rounded-lg cursor-pointer bg-black-50/15 hover:bg-black-100/  ${image ? 'relative overflow-hidden group' : ''
          }`}
      >
        {image && !edit ? (
